...
//                                    || it.startsWith("full:"))
    ...
    private fun dns(v2rayConfig: V2rayConfig): Boolean {
        try {
            ...
            val host = v2rayConfig.outbounds[0].streamSettings?.tlsSettings?.serverName
            val ip = v2rayConfig.outbounds[0].streamSettings?.tlsSettings?.serverIP
            if (host != null && host != "" && ip != null && ip != "") {
                hosts[host] = ip
            }
