            ...
            if (type == EConfigType.CUSTOM) {
                ...
                config.outboundBean?.streamSettings?.let { streamSetting ->
                    ...
                    streamSetting.populateTlsSettings(vmessBean.streamSecurity, allowInsecure,
                        vmessBean.sni.ifBlank { sni }, vmessBean.server_ip, fingerprint, null,
                        vmessBean.enableECH.toBoolean(), vmessBean.echDNS, null, null, null)
                }
            }
            ...
            if (str.startsWith(EConfigType.VMESS.protocolScheme)) {
                ...
                if (uri.rawQuery != null) {
                    ...
                    config.outboundBean?.streamSettings?.populateTlsSettings(TLS, allowInsecure, "", "",
                            fingerprint, null, false, "", null, null, null)
                }
        ...
        try {
            ...
            return config.configType.protocolScheme + when (config.configType) {
                EConfigType.VMESS -> {
                    ...
                    vmessQRCode.serverIP = streamSetting.tlsSettings?.serverIP.orEmpty()
                    vmessQRCode.enableECH = streamSetting.tlsSettings?.enableEch.toString()
                    vmessQRCode.echDNS = streamSetting.tlsSettings?.echSetting?.dnsAddr.orEmpty()
