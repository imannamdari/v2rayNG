    ...
    data class OutboundBean(val tag: String = "proxy",
        ...
        data class StreamSettingsBean(var network: String = DEFAULT_NETWORK,
            ...
            data class TlsSettingsBean(var allowInsecure: Boolean = false,
                ...
                data class ECHSettingBean(var dnsAddr: String = "1.1.1.1:53")
            }

            data class sockoptBean(var domainStrategy: String = "use_ip")
            ...
            fun populateTlsSettings(streamSecurity: String, allowInsecure: Boolean, sni: String, serverIP: String, fingerprint: String?, alpns: String?,
                                    enableECH: Boolean, echDNS: String, publicKey: String?, shortId: String?, spiderX: String?) {
                ...
                val tlsSetting = TlsSettingsBean(
                        ...
                        enableEch = enableECH,
                        echSetting = TlsSettingsBean.ECHSettingBean(dnsAddr = echDNS),
                        publicKey = publicKey,
                        shortId = shortId,
                        spiderX = spiderX
                )
